...
metadata: Belt.Map.String.t<Metadata.value>,
      ...
      let fromValue = (value: value): option<t> => {
        try {
          Some({username: (value.username)->Belt.Option.getExn,
...
type fields<'t, 'self> = {
    ...
    addresses: (ReasonForm.Field.t<'t, list<Address.value>>, int => Address.fields<'t, Address.value>),
    metadata: (ReasonForm.Field.t<'t, Belt.Map.String.t<Metadata.value>>, string => Metadata.fields<'t, Metadata.value>),
